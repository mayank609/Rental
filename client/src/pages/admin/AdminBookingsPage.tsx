...
export default function AdminBookingsPage() {
  ...
  const columns: Column<AdminBookingRow>[] = [
    ...
    { key: "renter", header: "Renter", hideBelow: "sm", sort: (b) => b.renter.name, cell: (b) => <span className="whitespace-nowrap">{b.renter.name}</span> },
    { key: "owner", header: "Owner", hideBelow: "sm", sort: (b) => b.owner.name, cell: (b) => <span className="whitespace-nowrap">{b.owner.name}</span> },
